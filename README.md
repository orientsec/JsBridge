...
inspired and modified from [lzyzsd/JsBridge](https://github.com/lzyzsd/JsBridge) with some bugs fix and feature enhancement.
...
add com.xiaomao.jsbridge.BridgeWebView to your layout, it is inherited from WebView.
